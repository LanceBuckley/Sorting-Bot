...
# We declare parse as ArgumentParser class of argparse and fill out its description property
parser = argparse.ArgumentParser(
    description="Clean up directory and put files into according folders."
)

# We add an argument, the -- in front of path tells argparse that it is an optional argument
# The default is '.' or the current directory
parser.add_argument(
    "--path",
    type=str,
    default=".",
